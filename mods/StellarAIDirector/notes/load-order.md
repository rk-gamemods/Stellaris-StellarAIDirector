...
- `common/ai_budget/zzz_staid_outpost_budgets.txt` preserves native alloy/food outpost planning and safety gates while moving the colonization-plan eligibility gate to a factor-0.25 allocation preference; load it after other outpost-budget overhauls.
